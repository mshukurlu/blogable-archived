        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="POST" action="{{route("backend.options.store")}}">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" value="" name="option_name" class="form-control"  placeholder="Options Key">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" value="" name="option_value" class="form-control"  placeholder="Option Value">
                                <p class="help-block" style="color:red">
