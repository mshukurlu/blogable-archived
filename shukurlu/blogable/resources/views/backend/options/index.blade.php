...
@section('content')
    ...
    <section class="content-header">
        ...
        <ol class="breadcrumb">
            ...
            <li><a href="{{route('backend.category.index')}}">Options</a></li>
                            ...
                            @foreach($data as $item)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <form style="display: none" id="deleteForm{{$item->id}}" action="{{route("backend.options.destroy",["id"=>$item->id])}}" method="POST">
                                            {{ method_field('delete') }}
                                            {{csrf_field()}}
                                            <button class="btn btn-default deleteItem" type="submit"></button>
                                        </form>

                                        <a href="{{route("backend.options.edit",['id'=>$item->id])}}"><i class="fa fa-fw fa-edit "></i></a>
