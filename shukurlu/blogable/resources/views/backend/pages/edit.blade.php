        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="POST" action="{{route("backend.posts.update",['id'=>$post->id])}}">
                        ...
                        <div class="box-body">
                            <div class="form-group">
                                ...
                                <input type="text" value="{{isset($post->title) ? $post->title : ""}}" name="title" class="form-control" id="exampleInputEmail1" placeholder="title">
                            ...
                            <div class="form-group">
                                ...
                                <select name="is_published" class="form-control">
                                    ...
                                    <option value="0" {{$post->is_published==0 ? "selected":""}}>Deactive</option>
                                    <option value="1" {{$post->is_published==1 ? "selected":""}}>Active</option>
                                </select>
