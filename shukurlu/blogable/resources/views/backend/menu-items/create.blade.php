        ...
        <div class="row">
            ...
            <div class="col-md-12">
                ...
                <div class="box box-primary">
                    ...
                    <!-- /.box-header -->
                    <!-- form start -->
                    <form method="POST" action="{{route("backend.menus.items.store",['slug'=>$menu])}}">
                        ...
                        <div class="box-body">
                            ...
                            <div class="form-group">
                                ...
                                <div>
                                <label class="radio-inline"><input type="radio" value="0" name="url_type" checked>URL</label>
                                <label class="radio-inline"><input type="radio" value="1" name="url_type" checked>Internal item</label>
                            ...
                            <div class="item_type_url" style="display: none">
                            <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <p><input type="checkbox" name="type" style="margin-top:2px"/> YES</p>
                                    <p class="helper-block red">
                            ...
                            <div class="form-group">
                                <label for="exampleInputFile">Attach to a Menu - Default menu is ()</label>
